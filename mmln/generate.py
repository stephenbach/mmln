...
def generate_mmln(label_model, all_labels, n_nodes, n_edges_per_node, gibbs_steps=1000, n_mmlns=1):
    ...
    for weight_type, weight_map in ((mmln.intra, intra_weight_map), (mmln.inter, inter_weight_map)):
        for (l1, l2), weight in label_model[weight_type].items():
...
def generate_label_model(all_labels, intra_density, inter_density):
