...
class TestInference(TestCase):
    ...
    def test_infer(self):
        for inf in self._get_inference_methods():
            ...
            inf.set_weight(1, 1, v1, -0.5, two_sided=True, squared=True)
            inf.set_weight(1, 1, v2, -0.5, two_sided=True, squared=True)
            inf.set_weight(1, 1, v3, -0.5, two_sided=True, squared=True)
            inf.set_weight(1, 1, v4, -0.5, two_sided=True, squared=True)
            inf.set_weight(1, 1, v5, -0.5, two_sided=True, squared=True)

            inf.set_weight(5, -1, v1, 1, squared=True)
            inf.set_weight(5, -1, v2, 1, squared=True)

            inf.set_weight(2, (1, -1), (v1, v3), 0, squared=True)
            inf.set_weight(2, (1, -1), (v3, v1), 0, squared=True)
            inf.set_weight(2, (1, -1), (v2, v3), 0, squared=True)
            inf.set_weight(2, (1, -1), (v3, v2), 0, squared=True)
            inf.set_weight(2, (1, -1), (v3, v4), 0, squared=True)
            inf.set_weight(2, (1, -1), (v4, v3), 0, squared=True)
            inf.set_weight(2, (1, -1), (v3, v5), 0, squared=True)
            inf.set_weight(2, (1, -1), (v5, v3), 0, squared=True)

            inf.set_weight(5, 1, v4, 0, squared=True)
            inf.set_weight(2, 1, v5, 0, squared=True)
